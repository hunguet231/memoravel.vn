    ...
    if (currAddress) {
      ...
      Promise.allSettled(
        Object.entries(structed).map(async ([key, val]) => {
          ...
          const dataBody = {
            pick_province: val[0].shop.address.city,
            pick_district: val[0].shop.address.district,
          ...
          if (val.delivery) {
            ...
            const dataBody = {
              ...
              order: {
                ...
                pick_address: val[0].shop.address.address_details,
                pick_province: val[0].shop.address.city,
                pick_district: val[0].shop.address.district,
                pick_ward: val[0].shop.address.ward,
                pick_tel: JSON.parse(val[0].shop.details).phone,
                name: currAddress.full_name,
                address: currAddress.address.address_details,
                province: currAddress.city,
                district: currAddress.district,
